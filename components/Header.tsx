...
const Header: React.FC = () => {
  return (
    <header className="w-full py-3 px-4 border-b border-slate-200 bg-white/80 backdrop-blur-sm sticky top-0 z-50 h-[53px]">
      <div className="flex items-center justify-center gap-2">
          <SparkleIcon className="w-5 h-5 text-primary-500" />
      </div>
    </header>
  );
};
